...
\rev{
Kawrykow and Robillard catalog trivial type declaration updates made to variables,
...
a technique that works with Abstract Syntax Tree (\entity{AST}) representations of
