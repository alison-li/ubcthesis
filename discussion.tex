...
From \rev{gathering feedback on the participants' experience using Intelligent History, 
...
be considered in our heuristics, such as dependency injections in Java Spring.
...
Additionally, to support projects that use a non-Jira \entity{ITS},
