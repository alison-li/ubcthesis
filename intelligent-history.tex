...
The raw diff metadata information for the commit history of \class{Topology} and \class{StreamsBuilder} respectively are available at \autoref{sec:Topology-Diff-Metadata} and \autoref{sec:StreamsBuilder-Diff-Metadata}.
