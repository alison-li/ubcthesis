...
Murphy-Hill \etal found refactorings are often committed with changes for separate tasks \cite{murphy-hill_refactor_2012}. 
...
The information in issue repositories represent a \emph{group memory} for a software project, which is a valuable repository of information current members of a project can use and benefit from as it contains past experiences \cite{cubranic_hipikat_2003,hassan_road_2008}.
...
\FIXME{Elaborate on the process of constucting a mental chronology or narrative about the context behind a change or a group of changes.}
Thus, we found it important to attempt to minimize the distance between a commit and its associated issue.
