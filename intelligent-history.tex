...
a Kafka Improvement Proposal\footnote{Kafka Improvement Proposals (\entity{KIP}s) in the Apache Kafka project are documents intended to capture the thought process behind major features introdcued and changes impacting the public Kafka \entity{API}s. 
