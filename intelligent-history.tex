...
Similar to the example we used to illustrate the developer's process of finding and synthesizing information about the change history of \code{StreamsBuilder} in the first 5 commits in its commit history, the developer can continue to use these features of Intelligent History on the rest of the highlighted commits to efficiently locate and access rationale information for changes over time.
