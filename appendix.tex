...
\begin{enumerate}
    ...
    \item There are several overloaded methods called \code{addSink} in this class. In your own words, can you describe in what context were these overloaded methods introduced to this class? Can you reference the commit that introduced these methods and the associated Jira issue in your explanation?
