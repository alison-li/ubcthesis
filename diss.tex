...
\examiningcommittee{Gail Murphy, Professor and Vice-President Research \& Innovation, Computer Science, \textsc{UBC}}{Supervisor}
\examiningcommittee{Ed Knorr, Associate Professor of Teaching Emeritus, Computer Science, \textsc{UBC}}%
...
%% files
\hypersetup{
  pdftitle={Reducing the Cognitive and Temporal Costs of Software History Exploration},
  pdfauthor={Alison Li},
  pdfkeywords={thesis}
}
...
\include{appendix-reg-ex}
\include{appendix-study-materials}
