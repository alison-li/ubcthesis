...
we introduce \rev{a new tool called Intelligent History that supports} two approaches.
...
The second approach attempts to reduce context switching between an \entity{IDE}
