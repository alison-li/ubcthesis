...
Additionally, Intelligent History minimizes the distance between a developer's \entity{IDE} and issues from an issue tracking system
...
We also conduct\rev{ed} a semi-structured interview on the participants' experiences with examining issues and commits 
