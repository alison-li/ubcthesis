...
\begin{itemize}[leftmargin=*]
    \item[] \RQ{1}{Does highlighting important commits help software developers explore a file’s revision history more effectively?}
...
For the group that did not use Intelligent History, a mean of 76.1\% of the commits they examined would have been highlighted commits under feature \feature{1} \textit{Highlight Important Commits} from Intelligent History.
...
Interestingly, all of the participants who used Intelligent History to answer A2 responded most positively to feature \feature{F1} from Intelligent History \participants{BDFHJ} (see \autoref{tab:Participants} and \autoref{tab:Flow-Chart-Tabular}).
...
Participant \participant{B} stated that when looking at the commits that were faded out by the highlighting feature in Intelligent History,
they agreed with the highlighting, commenting that the faded commits ``\textit{do not seem to be useful for this file [\file{Topology.java}] at all}''.
\participant{B} further said:
...
It may be worth noting that of the 6 participants who expressed preference for feature \feature{1}, 
...
\RQ{3}{How useful is direct integration of issue information in the \entity{IDE} for helping a developer search for code rationale information?}
...
We found that the utility of direct integration of issue information is dependent on a participant's background with examing commits and issues,
...
\begin{summary}[RQ3]
  Direct integration of issue information helped participants contextualize source code changes ...
\end{summary}
...
Given the nature of B1, we find direct integration of Jira issue information within the \entity{IDE} to be useful for \dots broad search and exploration of a commit history.
...
Similar in sentiment, participant \participant{G}, who favoured (\feature{3}), noted that it was primarily the hyperlinking of Jira issues for each commit
that they found to be most helpful in the user study.
