...
As mentioned in \autoref{subsec:RQ2} previously, 4 of the 5 participants from the group that answered question set B with Intelligent History actually favoured feature \feature{3} \textit{Show Jira Metadata} \participants{ACGI}.
