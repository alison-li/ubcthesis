...
\FIXME{Statistical significance test?}
...
The green checkmark indicates when a participant provided an answer to the question and the globe icon represents when a participant has made an application switch between the \entity{IDE} and their browser to further examine the Jira issue.
