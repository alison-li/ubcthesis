...
that a developer examines before \rev{being able to provide an answer} questions about the intent behind code changes.
...
to understand the changes in many commits which can be vague, empty, or limited in explaining
