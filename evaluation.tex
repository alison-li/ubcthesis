...
\FIXME{Give the reader a better sense of what the participant experienced and what we expect them to do to answer a question.}
...
\FIXME{Were there limitations placed on the interviewer's answers?}
...
However, participants were informed that the first commit in the \class{Topology} class introduced a series of \class{addSink} overloads already.
Hence, participants were encouraged to locate a particular commit that introduced overloads later in the history 
