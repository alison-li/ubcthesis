...
The small range of the questions we asked is a threat to construct validity.
...
We formulated a small set of questions to relieve participants from a time limit and give them the freedom to explore the commit histories and examine commits at their own pace.

Although the small range of questions allowed us to observe the participants closely for each question,
we exclude other categories of questions and the ability to observe the consistency of the participants' commit history exploration strategies across a wider range of questions
...
We attempted to mitigate this effect by minimizing interjections and interaction with the participants during the sessions and allowing participants to self-report and provide feedback on their experience 
participating in the user study during their follow-up interview.
...
We tried to mitigate bias in how a participant expects to use Intelligent History and the applicability of Intelligent History to any particular question set 
...
The experience of the participants with regard to having worked on a project that uses an issue tracking system (\entity{ITS}) and closely associating issues to commits impacts internal validity.
