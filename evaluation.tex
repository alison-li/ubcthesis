...
\rev{\autoref{fig:Issues-Viewed} shows the box-and-whisker plots for the number of issues viewed as part of answering each question,
...
\rev{reported often or sometimes} looking at commits and issues.
...
\begin{table}
  \caption{
    ...
    \rev{The frequency of looking at commits as \textit{often}, \textit{sometimes}, or \textit{rarely} are self-reported by participants.}
