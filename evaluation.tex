...
The mean proportion of commits examined for question B(b) by participants who did not Intelligent History and participants who did use Intelligent History appear to be close at 6.2\% and 5.8\% respectively.
This may be attributed to the fact that the commit \commit{e09d6d79} that contains the information necessary for answering this question has the commit message subject: 

\begin{center}
  \jira{KAFKA-7027:}{Add overloaded build method to StreamsBuilder (\#5437)} 
\end{center}

Participants were informed that the initial commit in the commit history for the \class{StreamsBuilder} class introduced a set overloaded \code{build} methods already.
Hence, participants were prompted or intuited to locate a particular commit that introduced further overloads later in the history.
...
For questions A(a) and B(b), we fail to reject the null hypothesis, indicating that the mean proportion of commits examined by the group without Intelligent History and the group with Intelligent History are equal.
\FIXME{Comment on the nature of the questions and maybe why this is true.}
...
The aggregated version is presented in \autoref{fig:Flow-Chart-Aggregate}.
The tabular form of \autoref{fig:Flow-Chart-Individual} is recorded in \autoref{tab:Flow-Chart-Tabular}.
\FIXME{This section could be worded better. Comment on the results.}
