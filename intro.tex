...
% TODO: Still uncertain about framing this thesis. We want a tool that will have two panels: commits and discussions. Try to reduce one side through the other, therefore streamlining the process of looking at both in a single interface while also having less noise in a history to look at. We hypothesize that this will reduce cognitive and temporal load of trying to explore commit history as a means of answering code rationale questions. We develop certain heuristics about both commits and JIRA issues that are adjustable for exploring commit history.
