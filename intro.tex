...
Similarly, \jira{KAFKA-7523} commited thereafter describes another topology configuration-related shortcoming and adds support for state stores to each processor node in a topology.
