...
Despite a wealth of tools supporting Git integration, Codoban \etal's survey of 217 developers found 47\% of respondents reporting the high volume of commits in a project to be a challenge of navigating commit history \cite{codoban_software_2015}. 
...
To gain a sense of how \class{Topology} has evolved over time and for further understanding the motivations behind code changes in the class, the developer manually inspects the diff between each of the 22 commits to understand how the code has evolved across commits.
...
\begin{center}
	\jira{KAFKA-7021:}{Reuse source based on config (\#5163)}
\end{center}
...
\begin{center}
	\jira{KAFKA-5671:}{Add StreamsBuilder and Deprecate KStreamBuilder}
\end{center}
...
In total, our heuristic-based approach, explained further in \autoref{sec:Heuristics}, shows 9 of 22 commits can be considered unimportant to the \class{Topology} class. 
...
To evaluate the effectiveness of our approach towards our hypothesis, we implement Intelligent History, a plugin for the IntelliJ IDEA \entity{IDE},
...
\begin{itemize}[leftmargin=*]
    \item[] \textbf{Research Question 1 (\entity{RQ1}):} \textit{Can we automatically identify the commits that software developers would want to examine?}
    \item[] \textbf{Research Question 2 (\entity{RQ2}):} \textit{Does highlighting important commits help software developers explore a file’s revision history more efficiently?}
    \item[] \textbf{Research Question 3 (\entity{RQ3}):} \textit{How useful is direct integration of issue information in the IDE for helping a developer search for code rationale information?}
\end{itemize}

Based on the analysis of our data collected, \dots
\FIXME{To be written later}.
...
\autoref{ch:Evaluation} details the evaluation of Intelligent History and the threats to validty.
\autoref{ch:Discussion} explores the implications of the results from the evaluation and suggestions for future work.
