...
is the title of one commit in the \class{KafkaStreams} class from the Apache Kafka repository.\footnote{\url{https://github.com/apache/kafka}, verified 7/20/2022.}
